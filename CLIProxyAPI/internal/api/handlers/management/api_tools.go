...
const (
	geminiOAuthClientID     = "[REMOVED_GEMINI_OAUTH_CLIENT_ID]"
	geminiOAuthClientSecret = "[REMOVED_GEMINI_OAUTH_CLIENT_SECRET]"
)
...
const (
	antigravityOAuthClientID     = "[REMOVED_ANTIGRAVITY_OAUTH_CLIENT_ID]"
	antigravityOAuthClientSecret = "[REMOVED_ANTIGRAVITY_OAUTH_CLIENT_SECRET]"
)
