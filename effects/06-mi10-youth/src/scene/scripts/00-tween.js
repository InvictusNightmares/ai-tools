/* Scene behavior: tween. Registered in original execution order. */
pc.extend(
  pc,
  (function () {
    var t = function (t) {
    ...
    i.prototype = {
      ...
      delay: function (t) {
        return ((this._delay = t), (this.pending = true), this);
      },
      repeat: function (t, i) {
        return (
          (this._count = 0),
      ...
      update: function (t) {
        ...
        if (
          ...
          if (!(this.time > this._currentDelay)) return true;
          this._reverse
    ...
    return {
      ...
      BounceInOut: function (t) {
        return t < 0.5 ? 0.5 * n(2 * t) : 0.5 * s(2 * t - 1) + 0.5;
      },
  ...
  (function (T) {
    ...
    function c(T, e) {
      ...
      for (S = e.toLowerCase(), i = 0; i < o; ++i)
        if (S === T[i].toLowerCase()) return true;
      return false;
    }
    function d(T) {
    ...
    return (
      ...
      (function () {
        ...
        for (e in b.props)
          if (i.call(b.props, e)) {
            for (
              o = b.props[e], T(o) || (o = [o]), M = o.length, a = 0;
              a < M;
              ++a
            ) {
              (A = (P = o[a]).indexOf("[VER]")) >= 0 &&
                (P = P.substring(0, A) + "([\\w._\\+]+)" + P.substring(A + 5));
              o[a] = new RegExp(P, "i");
            }
            b.props[e] = o;
          }
      ...
      (S.findMatch = function (T, e) {
        for (var S in T) if (i.call(T, S) && T[S].test(e)) return S;
        return null;
      }),
      (S.findMatches = function (T, e) {
        var S = [];
        for (var o in T) i.call(T, o) && T[o].test(e) && S.push(o);
        return S;
      }),
      (S.getVersionStr = function (T, e) {
        var o,
          ...
          a,
          M,
          A = S.mobileDetectRules.props;
        if (i.call(A, T))
          for (a = (o = A[T]).length, P = 0; P < a; ++P)
            if (null !== (M = o[P].exec(e))) return M[1];
        return null;
      }),
      ...
      (S.prepareVersionNo = function (T) {
        var e;
        return (
          1 === (e = T.split(/[a-z._ \/\-]/i)).length && (T = e[0]),
      ...
      (S.isMobileFallback = function (T) {
        return (
          S.detectMobileBrowsers.fullPattern.test(T) ||
          S.detectMobileBrowsers.shortPattern.test(T.substr(0, 4))
        );
      }),
      (S.isTabletFallback = function (T) {
        return S.detectMobileBrowsers.tabletPattern.test(T);
      }),
      (S.prepareDetectionCache = function (T, i, o) {
        var P, a, M;
        if (T.mobile === e)
          return (a = S.findMatch(S.mobileDetectRules.tablets, i))
            ? ((T.mobile = T.tablet = a), void (T.phone = null))
            : (P = S.findMatch(S.mobileDetectRules.phones, i))
              ? ((T.mobile = T.phone = P), void (T.tablet = null))
              : void (S.isMobileFallback(i)
                  ? (M = f.isPhoneSized(o)) === e
                    ? ((T.mobile = S.FALLBACK_MOBILE),
                      (T.tablet = T.phone = null))
                    : M
                      ? ((T.mobile = T.phone = S.FALLBACK_PHONE),
                        (T.tablet = null))
                      : ((T.mobile = T.tablet = S.FALLBACK_TABLET),
                        (T.phone = null))
                  : S.isTabletFallback(i)
                    ? ((T.mobile = T.tablet = S.FALLBACK_TABLET),
                      (T.phone = null))
      ...
      (S.detectOS = function (T) {
        return (
          S.findMatch(S.mobileDetectRules.oss0, T) ||
          S.findMatch(S.mobileDetectRules.oss, T)
        );
      }),
      ...
      (f.prototype = {
        ...
        mobile: function () {
          return (
            S.prepareDetectionCache(this._cache, this.ua, this.maxPhoneWidth),
            this._cache.mobile
          );
        },
        phone: function () {
        ...
        userAgent: function () {
          return (
            this._cache.userAgent === e &&
              (this._cache.userAgent = S.findMatch(
                S.mobileDetectRules.uas,
                this.ua,
              )),
        ...
        userAgents: function () {
          return (
            this._cache.userAgents === e &&
              (this._cache.userAgents = S.findMatches(
                S.mobileDetectRules.uas,
                this.ua,
              )),
        ...
        os: function () {
          return (
            this._cache.os === e && (this._cache.os = S.detectOS(this.ua)),
            this._cache.os
          );
        },
        version: function (T) {
        ...
        is: function (T) {
          return (
            ...
            a(T, this.phone()) ||
            a(T, this.tablet()) ||
            c(S.findMatches(S.mobileDetectRules.utils, this.ua), T)
          );
        },
        match: function (T) {
          return (
        ...
        isPhoneSized: function (T) {
          return f.isPhoneSized(T || this.maxPhoneWidth);
        },
        mobileGrade: function () {
          return (
            this._cache.grade === e &&
              (this._cache.grade = S.mobileGrade(this)),
            this._cache.grade
          );
        },
      }),
